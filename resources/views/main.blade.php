        ...
        <section id="event" class="">
            <div class="container pb-50">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <article class="post media-post clearfix pb-0 mb-10">
                                ...
                                <h4 class="mt-0 mb-5"><a href="#">Upcoming Event BU CSE Family Cricket Fest-2021</a></h4>
                  <ul class="list-inline font-12 mb-5">
                    <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 20, 2021 |</li>
                    <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>BU Campus</li>
                  </ul>
                  <p class="mb-0 font-13">BU CSE Family Cricket Fest-2014. news. September 2, 2021 Comments Off on BU CSE Family Cricket Fest-2021</p>
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                ...
                <div class="post-right">
                  <h4 class="mt-0 mb-5"><a href="#">Upcoming Event CSE Week </a></h4>
                  <ul class="list-inline font-12 mb-5">
                    <li class="pr-0"><i class="fa fa-calendar mr-5"></i> 13 JUNE, 2014 |</li>
                    <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>Auditorium-Bangladesh University</li>
                  </ul>
                  <p class="mb-0 font-13">2021 Comments Off on BU CSE Family Cricket Fest-2021.</p>
                  <a class="text-theme-colored font-13" href="#">Read More →</a>
                </div>
              </article>
              <article class="post media-post clearfix pb-0 mb-10">
                ...
                <div class="post-right">
                  <h4 class="mt-0 mb-5"><a href="#">Upcoming Event Summit on sustainable</a></h4>
                  <ul class="list-inline font-12 mb-5">
                    <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2021 |</li>
                    <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>Dhaka Unisersity</li>
                  </ul>
                  <p class="mb-0 font-13">E-registration Open for the inaugural session of the International e-Conference on Celebrating 100 years of the University of Dhaka.</p>
                  <a class="text-theme-colored font-13" href="#">Read More →</a>
                </div>
                            </article>
                        </div>
                        ...
                        <div class="owl-carousel-2col boxed" data-dots="true">
                            <div class="item">
                                <div class="testimonial pt-10">
                                    ...
                                    <div class="ml-100 ">
                                        <h4 class="text-white mt-0">Writing 1000 has been such a valuable course for me, both academically and personally. As a result of this course, I was able to successfully compete and place 3rd in a National Marketing Competition; I was also able to attain the summer position of my dreams! Writing 1000 is one of the most important and useful courses you will ever take in University.</h4>
                            ...
                            <div class="item">
                                <div class="testimonial pt-10">
                                    ...
                                    <div class="ml-100 ">
                                        <h4 class="text-white mt-0">I just wanted to thank you for the great course this semester. Though I originally was only taking it since I had to (since I am going into Ed), I am so happy that I took it and that you were my professor. I learned a lot in your class that I will take with me for the rest of my courses in university.</h4>
                                        <p class="author mt-20">- <span
                                                class="text-theme-color-2">Catherine Grace,</span> <small><em
                                                    class="text-gray-lightgray">CEO apple.inc</em></small></p>
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonial pt-10">
                                    ...
                                    <div class="ml-100 ">
                                        <h4 class="text-white mt-0">Thanks again for a great class. It was challenging, but I learned a lot. I feel like I made it over a big writing-style/technique hurdle. My writing will be forever changed (for the better) because of your class and 'tough love'!</h4>
                                        <p class="author mt-20">- <span
                                                class="text-theme-color-2">Catherine Grace,</span> <small><em
                                                    class="text-gray-lightgray">CEO apple.inc</em></small></p>
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonial pt-10">
                                    ...
                                    <div class="ml-100 ">
                                        <h4 class="text-white mt-0">I am so happy that I took it and that you were my professor. I learned a lot in your class that I will take with me for the rest of my courses in university.</h4>
                                        <p class="author mt-20">- <span
                                                class="text-theme-color-2">Catherine Grace,</span> <small><em
                                                    class="text-gray-lightgray">CEO apple.inc</em></small></p>
                                    </div>
